...
export default {
  async fetch(request, env, ctx) {
    ...
    if (m === 'GET' && p === '/admin/api/scrape/relay-health') return isAdmin ? handleAdminScrapeRelayHealth(env) : json({ok:false,error:'Unauthorized'},401);
